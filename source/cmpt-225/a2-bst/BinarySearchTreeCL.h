...
class BinarySearchTree
{
  public:
    ...
    int countLeaves( ostream & out = cout ) const
    {
        int num = 0;
        if( isEmpty( ) )
            out << "Empty tree" << endl;
        else
            return countLeaves( root, out );    
    }
...
*****************************************************/
    ...
    int countLeaves( BinaryNode *t, ostream & out) const
    {
        if( t == nullptr )
            return 0;
        if( t->left == nullptr && t->right == nullptr)
            ...
            return countLeaves (t->left, out) + countLeaves (t->right, out);
    }
