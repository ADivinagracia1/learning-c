...
class BinarySearchTree
{
  public:
    ...
    void displayDeep( int target, ostream & out = cout ) const
    {   
        out << "Display from depth " << target << endl;
        if( isEmpty( ) )
            out << "Empty tree" << endl;
        else
            displayDeep( root, 0, target, out );
    }
...
*****************************************************/
    ...
    void displayDeep( BinaryNode *t, int depth, int target, ostream & out ) const
    {
        const int SHIFT = 4;
        if( t != nullptr )
        {
            ...
            displayDeep( t->left, depth+1, target, out );
            displayDeep( t->right, depth+1, target, out );
        }
    }
